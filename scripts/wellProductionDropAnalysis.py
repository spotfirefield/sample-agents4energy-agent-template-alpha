...
production_df = production_df[production_df['Gas(MCF)'] > 0]  # Remove zero or negative values
...
gas_rates_MCFD = production_df['Gas(MCF)'].values * 12/365.25
...
try:
    ...
    # Update layout
    fig.update_layout(
        title=f'Well {well_api_number} - Gas Production Hyperbolic Decline',
        xaxis_title='Date',
